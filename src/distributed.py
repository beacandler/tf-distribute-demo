...
flags.DEFINE_string('ps_hosts', '10.240.209.96:8888', 'Comma-separated list of hostname:port pairs')
# 两个worker节点
flags.DEFINE_string('worker_hosts', '10.240.209.95:8888,10.240.209.95:9999',
...
def main(unused_argv):
    ...
    with tf.device(tf.train.replica_device_setter(
        ...
        print 'After %d training step(s), validation cross entropy = %g, accuracy: %f' % (FLAGS.train_steps, val_xent, val_accuracy)
        sess.close()
